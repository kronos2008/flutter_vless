...
void main() {
  final FlutterVlessAndroidEmulatorPlatform initialPlatform = FlutterVlessAndroidEmulatorPlatform.instance;

  test('$MethodChannelFlutterVlessAndroidEmulator is the default instance', () {
    expect(initialPlatform, isInstanceOf<MethodChannelFlutterVlessAndroidEmulator>());
  });

  test('getPlatformVersion', () async {
    FlutterVlessAndroidEmulator flutterVlessAndroidEmulatorPlugin = FlutterVlessAndroidEmulator();
    MockFlutterVlessAndroidEmulatorPlatform fakePlatform = MockFlutterVlessAndroidEmulatorPlatform();
